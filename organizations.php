...
<body>
    ...
    <div class="organizations">
        <div class="container">
        <h1 class="tag-name">ארגונים ממשלתיים</h1>
          <div class="row">
            <div class="col-md-3">
              <div class="card">
      ...
      <a href="#" class="see-more">ראה עוד...</a>
        </div>
    </div>
...
<div class="organizations">
    <div class="container">
    <h1 class="tag-name">קופות חולים</h1>
      <div class="row">
        <div class="col-md-3">
          <div class="card">
            <img class="card-img-top" src="https://via.placeholder.com/286x180" alt="Card image cap">
  ...
  <div class="organizations">
      <div class="container">
      <h1 class="tag-name">מרכזים רפואיים</h1>
        <div class="row">
          <div class="col-md-3">
            <div class="card">
              <img class="card-img-top" src="https://via.placeholder.com/286x180" alt="Card image cap">
